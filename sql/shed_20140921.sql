...
INSERT INTO `comp` VALUES ('471', 'comp_0012', '吊环螺母', '1', null, null, null, 'PCS', null);
...
INSERT INTO `comp` VALUES ('492', 'comp_0033', '水槽片', '1', null, null, null, 'PCS', null);
...
INSERT INTO `comp` VALUES ('526', 'comp_1016', '水槽片组', '0', null, null, null, '个', '');
...
INSERT INTO `compdtl` VALUES ('511', '475', '4');
...
INSERT INTO `exp` VALUES ('18', '水槽片组通用计算公式', '/*\r\n 水槽片3米长。\r\n 按最短的棚长来算。\r\n */\r\n\r\nfunction run(lengths, topScrolls, edgeScrolls, frontScrolls, store, args){\r\n    var count = 0;\r\n    for(var i = 1; i < lengths.length; ++i){\r\n        var l = Math.min(lengths[i], lengths[i-1]);\r\n        count += l/3;//每3米一个\r\n    }\r\n    return count;\r\n}', '');
