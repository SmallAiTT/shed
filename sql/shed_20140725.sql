...
-- Records of comp
-- ----------------------------
INSERT INTO `comp` VALUES ('5', 'aa', 'ff', '0', 'asdfde', 'eadf', 'LZB', 'ff', 'asdf');
...
CREATE TABLE `compdtl` (
  ...
  `childId` bigint(64) DEFAULT NULL,
...
CREATE TABLE `compexp` (
  ...
  `calcArgs` varchar(50) DEFAULT NULL,
  `remark` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for shedschema
-- ----------------------------
DROP TABLE IF EXISTS `shedschema`;
CREATE TABLE `shedschema` (
  `id` bigint(64) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
  `remark` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
