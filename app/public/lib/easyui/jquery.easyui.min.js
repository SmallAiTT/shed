            ...
            $(_53b).children("thead").each(function(){
                ...
                $(this).find("tr").each(function(){
                    ...
                    $(this).find("th").each(function(){
                        var th=$(this);
                        var col=$.extend({},$.parser.parseOptions(this,["combodata", "field","align","halign","order",{sortable:"boolean",checkbox:"boolean",resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number",width:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),combodata:(th.attr("combodata")?eval(th.attr("combodata")):undefined),formatter:(th.attr("formatter")?eval(th.attr("formatter")):undefined),styler:(th.attr("styler")?eval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?eval(th.attr("sorter")):undefined)});
                        if(th.attr("editor")){
        ...
        for(var i=0;i<_6e0.length;i++){
            ...
            if(col){
                ...
                if(col.checkbox){
                    ...
                    if(col.combodata){
                        var flagii = false;
                        for(var ii = 0; ii < col.combodata.length; ++ii){
                            var dii = col.combodata[ii];
                            if(dii.value == _6e6) {
                                flagii = true;
                                cc.push(dii.text);
                                break;
